...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('doctor', '0002_rename_id_doctor_doctor_doctor_id_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('register', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='register.register')),
            ],
            options={
                'db_table': 'history',
            },
