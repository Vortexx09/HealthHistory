...
class Register(models.Model):
    ...
    disability = models.BooleanField(max_length=2, null=True)
    diabetes = models.BooleanField(default=False, null=True)
    cancer = models.BooleanField(default=False, null=True)
    alcohol_consumption = models.BooleanField(default=False, null=True)
    smoker = models.BooleanField(default=False, null=True)
    drug_use = models.BooleanField(default=False, null=True)
    occupational_risk = models.TextField(null=True, blank=True)
